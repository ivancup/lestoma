...
<div class="item form-group">
    {!! Form::label('protocolo','Protocolo', ['class'=>'control-label col-md-3 col-sm-3 col-xs-12']) !!}
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! Form::text('protocolo', old('protocolo'),[ 'class' => 'form-control col-md-6 col-sm-6 col-xs-12', 'required' => 'required',
