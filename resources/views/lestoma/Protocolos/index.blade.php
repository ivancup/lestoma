...
@section('content') @component('admin.components.panel') @slot('title', 'Protocolos')
    <div class="col-md-12">
        <div class="actions">
            <a href="{{ route('admin.protocolos.create') }}" class="btn btn-info">
                <i class="fa fa-plus"></i> Agregar Protocolo</a></div>
    </div>
    <br>
    <br>
    <br>
...
@push('functions')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            table = $('#protocolo-table-ajax').DataTable({
                processing: true,
                serverSide: false,
                stateSave: true,
                keys: true,
                ...
                "ajax": "{{ route('admin.protocolos.data') }}",
                "columns": [
            ...
            table.on('click', '.remove', function (e) {
                ...
                var route = '{{ url('admin/protocolos') }}' + '/' + dataTable.id;
                var type = 'DELETE';
                dataType: "JSON",
            ...
            table.on('click', '.edit', function (e) {
                ...
                $tr = $(this).closest('tr');
                var dataTable = table.row($tr).data();
                var route = '{{ url('admin/protocolos/') }}' + '/' + dataTable.id + '/edit';
        ...
        function SwalDelete(id, route) {
            swal({
                title: 'Esta seguro?',
                text: "El protocolo sera eliminado permanentemente!",
                type: 'warning',
