...
@section('content') @component('admin.components.panel') @slot('title', 'Sedes')
    <div class="col-md-12">
        <div class="actions">
            <a href="{{ route('admin.sedes.create') }}" class="btn btn-info">
    ...
    <br>
    <div class="col-md-12">
        @component('admin.components.datatable', ['id' => 'sede-table-ajax']) @slot('columns', [
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            if (sesion != null) {
                ...
                new PNotify({
                    title: "Sedes Modificada!",
                    text: sesion,
                    type: 'success',
                    styling: 'bootstrap3'
                });
            }
            table = $('#sede-table-ajax').DataTable({
                processing: true,
                serverSide: false,
                stateSave: true,
                keys: true,
            ...
            table.on('click', '.remove', function (e) {
                ...
                var route = '{{ url('admin/sedes') }}' + '/' + dataTable.id;
                var type = 'DELETE';
                dataType: "JSON",
            ...
            table.on('click', '.edit', function (e) {
                ...
                $tr = $(this).closest('tr');
                var dataTable = table.row($tr).data();
                var route = '{{ url('admin/sedes/') }}' + '/' + dataTable.id + '/edit';
